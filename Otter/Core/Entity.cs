...
public class Entity
{
    ...
    public Component this[int id]
    {
        get
        {
            return componentsById.TryGetValue(id, out Component value) ? value : null;
        }
    }
    ...
    private readonly Dictionary<int, Component> componentsById = [];
    ...
    {
        get => Surfaces == null || Surfaces.Count == 0 ? null : Surfaces[^1];
        set
        {
            Surfaces.Clear();
            Surfaces.Add(value);
    ...
    {
        get => Colliders.Count == 0 ? null : Colliders[0];
    ...
    /// </summary>
    public Input Input => Scene.Game.Input;
    ...
    /// </summary>
    public bool IsPaused => Scene != null && Scene.IsGroupPaused(Group);
    ...
    public float ScreenX
    {
        get
        {
            return Scene != null ? X - Scene.CameraX : X;
        }
    }
    ...
    public float ScreenY
    {
        get
        {
            return Scene != null ? Y - Scene.CameraY : Y;
        }
    }
    ...
    {
        get => Graphics.Count == 0 ? null : Graphics[0];
    ...
    public bool Overlap(float x, float y, params int[] tags)
    {
        ...
        if (Collider == null)
        {
            return false; // If no collider, cant possibly overlap.
        }
