...
public class Bone : Component
{
    ...
    public float X { get => x; set => LocalX = value; }
    public float Y { get => y; set => LocalY = value; }
    public float Rotation { get => rotation; set => LocalRotation = value; }
    public float ScaleX { get => scaleX; set => LocalScaleX = value; }
    public float ScaleY { get => scaleY; set => LocalScaleY = value; }

    public bool FlipX { get => flipX; set => LocalFlipX = value; }
    public bool FlipY { get => flipY; set => LocalFlipY = value; }
    ...
    private bool slotFlipX;
    private bool slotFlipY;
    ...
    public void UpdateTransforms()
    {
        ...
        if (Parent != null)
        {
            ...
            rotation = InheritRotation ? Parent.Rotation + LocalRotation + BaseRotation : LocalRotation + BaseRotation;
        ...
        if (Entity != null)
        {
            ...
            {
                slotRotation = FlipX && FlipY ? 180 + Rotation : Rotation;
            }
