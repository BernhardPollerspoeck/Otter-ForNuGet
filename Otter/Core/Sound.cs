...
public class Sound
{
    ...
    {
        get => globalVolume;
        set => globalVolume = Util.Clamp(value, 0, 1);
    }
    ...
    public static Vector3 ListenerDirection
    {
        ...
        get => (Vector3)Listener.Direction;
    }
    ...
    private readonly SFML.Audio.Sound sound;
    ...
    public int Offset
    {
        ...
        get => (int)sound.PlayingOffset.AsMilliseconds();
    }
    ...
    /// </summary>
    public int Duration => (int)sound.SoundBuffer.Duration.AsMilliseconds();
