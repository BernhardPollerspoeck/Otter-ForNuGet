...
public class PixelCollider : Collider
{
    ...
    /// </summary>
    public byte[] Pixels => collideImage.Pixels;

    #endregion

    #region Private Fields

    private readonly SFML.Graphics.Image collideImage;
    private readonly SFML.Graphics.Texture texture;
    private Texture visibleTexture;
    private Graphic visibleImage;
    ...
    {
        return x >= 0 && y >= 0 && x <= Width && y <= Height && collideImage.GetPixel((uint)x, (uint)y).A > Threshold;
    }
