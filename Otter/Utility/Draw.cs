...
public class Draw
{
    ...
    static internal SpriteBatch SpriteBatch = new();

    static internal RenderStates renderStates = RenderStates.Default;
    private static readonly RectangleShape tempRect = new();
    private static readonly CircleShape tempCircle = new();
    ...
    static internal void Drawable(Drawable drawable, RenderStates states)
    {
        ...
        if (Game.Instance.countRendering)
        {
    ...
    {
        Graphic(new OtterText.Text(str, size), x, y);
    }
    ...
    static public void Circle(float x, float y, int radius, Graphics.Color fill = null, Graphics.Color outline = null, float outlineThickness = 0)
    {
        ...
        tempCircle.FillColor = fill == null ? Graphics.Color.White.SFMLColor : fill.SFMLColor;

        tempCircle.OutlineThickness = outlineThickness;

        tempCircle.OutlineColor = outline == null ? Graphics.Color.None.SFMLColor : outline.SFMLColor;
    ...
    static public void Rectangle(float x, float y, float width, float height, Graphics.Color fill = null, Graphics.Color outline = null, float outlineThickness = 0)
    {
        ...
        tempRect.OutlineColor = outline == null ? Graphics.Color.None.SFMLColor : outline.SFMLColor;
        tempRect.OutlineThickness = outlineThickness;

        tempRect.FillColor = fill == null ? Graphics.Color.White.SFMLColor : fill.SFMLColor;
    ...
    {
        VertexArray vertices = new(PrimitiveType.TriangleFan);

        var rotationSteps = 10;
