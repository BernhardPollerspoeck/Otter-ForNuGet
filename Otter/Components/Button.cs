...
public class Button : Component
{
    ...
    private bool buttonsDown = false,
    ...
    /// </summary>
    public List<List<int>> JoyButtons = [];
    ...
    /// </summary>
    public bool Pressed => Enabled && currentButtonsDown && !prevButtonsDown;

    /// <summary>
    /// Check if the button has been released.
    /// </summary>
    public bool Released => Enabled && !currentButtonsDown && prevButtonsDown;

    /// <summary>
    /// Check if the button is down.
    /// </summary>
    public bool Down => Enabled && currentButtonsDown;

    /// <summary>
    /// Check if the button is up.
    /// </summary>
    public bool Up => Enabled && !currentButtonsDown;
    ...
    public Button AddButton(Button source)
    {
        ...
        JoyButtons.EachWithIndex((b, i) => JoyButtons[i].AddRange(source.JoyButtons[i]));
    ...
    public override void UpdateFirst()
    {
        ...
        if (LastPressed == float.MaxValue)
        {
            LastPressed = 0;
        }

        if (LastReleased == float.MaxValue)
        {
            LastReleased = 0;
        }
        ...
        for (var i = 0; i < JoyButtons.Count; i++)
        {
