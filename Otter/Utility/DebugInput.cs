...
public class DebugInput
{
    ...
    /// </summary>
    public static DebugInput Instance { get; set; }
    ...
    {
        return Enabled && Game.Input.KeyPressed(k);
    }
    ...
    {
        return Enabled && Game.Input.KeyReleased(k);
    }
    ...
    {
        return Enabled && Game.Input.KeyDown(k);
    }
    ...
    {
        return Enabled && Game.Input.KeyUp(k);
    }
