...
public abstract class Graphic
{
    ...
    protected VertexArray SFMLVertices = new(PrimitiveType.Quads);
    protected Drawable SFMLDrawable;
    private float shakeX;
    private float shakeY;

    public List<Transformation> Transforms = [new Transformation()];
    ...
    public Transformation Transform => Transforms[0];
    ...
    public float X
    {
        ...
        set => Transform.Translation.X = value;
    }
    ...
    public float Y
    {
        ...
        set => Transform.Translation.Y = value;
    }
    ...
    public Color Color
    {
        ...
        set
        {
            ...
            color = new Color(value)
            {
                ...
                Graphic = this
            }; // 2015/2/12: testing copying the color because of a bug
            NeedsUpdate = true;
        }
    }
    ...
    {
        get => Texture != null && Texture.Smooth;
        set
        {
            if (Texture != null)
            {
    ...
    /// </summary>
    public float Left => X - OriginX;

    /// <summary>
    /// The Y position of the top of the Graphic.
    /// </summary>
    public float Top => Y - OriginY;
    ...
    /// </summary>
    public int TextureLeft => AtlasRegion.Left + TextureRegion.Left;

    /// <summary>
    /// The X position of the right of the Texture.
    /// </summary>
    public int TextureRight => TextureLeft + TextureRegion.Width;

    /// <summary>
    /// The Y position of the top of the Texture.
    /// </summary>
    public int TextureTop => AtlasRegion.Top + TextureRegion.Top;

    /// <summary>
    /// The Y position of the bottom of the Texture.
    /// </summary>
    public int TextureBottom => TextureTop + TextureRegion.Height;
    ...
    {
        RenderStates renderStates = Texture != null ? new RenderStates(Texture.SFMLTexture) : RenderStates.Default;
    ...
    public virtual void Render(float x = 0, float y = 0)
    {
        ...
        var renderX = X + x + shakeX;
        var renderY = Y + y + shakeY;
        ...
        Drawable drawable = SFMLDrawable ?? SFMLVertices;
        if (!RepeatX && !RepeatY)
        {
    ...
    internal static SFML.Graphics.BlendMode SFMLBlendMode(BlendMode blend)
    {
        return blend switch
        {
            ...
            BlendMode.None => SFML.Graphics.BlendMode.None,
