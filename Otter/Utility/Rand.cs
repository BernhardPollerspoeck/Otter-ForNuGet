...
public static class Rand
{
    ...
    private static readonly List<Random> randoms = [];
    ...
    /// </summary>
    public static Vector2 Direction => Util.Normal(Angle);
    ...
    /// </summary>
    public static Color Color => new(Float(1), Float(1), Float(1), 1);

    /// <summary>
    /// Generate a random Color with a random Alpha.
    /// </summary>
    public static Color ColorAlpha => new(Float(1), Float(1), Float(1), Float(1));
